...
data = pd.read_excel("etherum_one-year_data.xlsx", parse_dates=['Date'])
...
if filtered_data.empty:
    ...
    st.title(f"Etherum Price Line Chart (Filtered: {min_price}-{max_price})")
    line_fig = go.Figure()

    # Add line graph for Etherum price
    ...
    line_fig.update_layout(
        title=f"Etherum Line Chart (Filtered: {min_price}-{max_price})",
        xaxis_title='Date',
        yaxis_title='Price',
    ...
    st.title(f"Etherum Candlestick Chart (Filtered: {min_price}-{max_price})")
    ...
    candlestick_fig.update_layout(
        title=f"Etherum Candlestick Chart (Filtered: {min_price}-{max_price})",
        xaxis_title='Date',
        yaxis_title='Price',
        template='plotly_dark',
        xaxis_rangeslider_visible=False
